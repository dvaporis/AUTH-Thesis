...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{epoch_train_total_by_video_obstruct_frames.png}
	\caption{Γραφήματα τιμών train loss per epoch για διάφορες τιμές obstructed video frames}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{epoch_val_gate_audio_by_video_obstruct_frames.png}
	\caption{Γραφήματα τιμών της audio gate στο validation set per epoch για διάφορες τιμές obstructed video frames}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{epoch_val_gate_video_by_video_obstruct_frames.png}
	\caption{Γραφήματα τιμών της video gate στο validation set per epoch για διάφορες τιμές obstructed video frames}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{epoch_val_ter_by_video_obstruct_frames.png}
	\caption{Γραφήματα τιμών val TER per epoch για διάφορες τιμές obstructed video frames}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{epoch_val_total_by_video_obstruct_frames.png}
